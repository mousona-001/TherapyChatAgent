...
export class DrizzleProfileAdapter implements IProfilePort {
  ...
  async updateTherapistProfile(userId: string, data: Partial<TherapistProfileData>) {
    const [updated] = await db
      ...
      .set({
        ...
        ...(data.therapistType !== undefined && { therapistType: data.therapistType }),
        ...(data.licenseNumber !== undefined && { licenseNumber: data.licenseNumber }),
        ...(data.licenseType !== undefined && { licenseType: data.licenseType }),
        ...(data.specializations !== undefined && { specializations: JSON.stringify(data.specializations) }),
        ...(data.yearsOfExperience !== undefined && { yearsOfExperience: data.yearsOfExperience }),
        ...(data.isAvailable !== undefined && { isAvailable: data.isAvailable }),
        ...(data.amountInPaise !== undefined && { amountInPaise: data.amountInPaise }),
  ...
  async updatePatientProfile(userId: string, data: Partial<PatientProfileData>) {
    const [updated] = await db
