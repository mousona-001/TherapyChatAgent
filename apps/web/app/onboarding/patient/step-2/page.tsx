...
import { CaretDown, DeviceMobile, Info, User } from "@phosphor-icons/react";
import {
	Button,
	Combobox,
	DatePicker,
	...
	return (
		<OnboardingLayout>
			...
			<p className="text-[0.95rem] font-normal text-[var(--on-surface-variant)] text-center leading-[1.65] max-w-[440px] mb-[3rem]">
				We&apos;ll use your details to prepare your care profile and verify your
				identity before connecting you with a provider.
			</p>
