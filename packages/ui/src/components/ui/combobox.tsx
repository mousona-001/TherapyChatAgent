			...
			<PopoverTrigger asChild>
				<button
					...
					className={cn(
						...
						"bg-[var(--surface-container-low)] text-[var(--on-surface)] text-[0.9rem] font-medium",
						"rounded-[var(--r-sm)] border-b-2 border-transparent outline-none",
						"transition-all cursor-pointer text-left",
						"hover:bg-[var(--surface-container)] hover:border-b-[var(--on-surface-variant)]/30 hover:shadow-xs",
